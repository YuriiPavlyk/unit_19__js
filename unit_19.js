...
function t4() {
  let val = document.querySelector(".div-4").textContent;
...
function t5() {
  let elem = document.querySelector(".div-5.active");
...
function t13() {
  let elem = document.querySelector(".div-13");
...
function t15() {
  let elem = +document.querySelector(".div-15").textContent;
...
function t17On() {
  document.querySelector(".b-17_on").addEventListener("click", t16);
}
function t17Off() {
  document.querySelector(".b-17_off").removeEventListener("click", t16);
}
...
function t18() {
  ...
  block.innerHTML = block.offsetWidth;
}
